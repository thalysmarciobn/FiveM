    ...
    public class FiveMContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AccountModel>(e =>
            {
                ...
                e.HasMany(m => m.Character).WithOne().HasPrincipalKey(m => m.Id).HasForeignKey(m => m.AccountId)
            ...
            modelBuilder.Entity<AccountCharacterModel>(e =>
            {
                ...
                e.HasOne(m => m.Rotation).WithOne().HasForeignKey<AccountCharacterRotationModel>(m => m.CharacterId)
                    .OnDelete(DeleteBehavior.Cascade);
                e.HasOne(m => m.PedHeadData).WithOne()
                    .HasForeignKey<AccountCharacterPedHeadDataModel>(m => m.CharacterId)
                    .OnDelete(DeleteBehavior.Cascade);
                e.HasOne(m => m.PedHead).WithOne().HasForeignKey<AccountCharacterPedHeadModel>(m => m.CharacterId)
                    .OnDelete(DeleteBehavior.Cascade);
                e.HasMany(m => m.PedFace).WithOne().HasForeignKey(m => m.CharacterId).OnDelete(DeleteBehavior.Cascade);
                e.HasMany(m => m.PedComponent).WithOne().HasForeignKey(m => m.CharacterId)
                    .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity<ServerVehicleService>(e =>
            {
                ...
                e.HasData(new ServerVehicleService
                {
                    Id = 1,
                    // VehicleHash.Bus
                    Model = 3338918751u,
